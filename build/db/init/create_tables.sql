...
VALUES
("はなこ", "街中で知らない人がわざと肩をぶつけてきて怖かった"),
("かなこ", "悪意があるわけじゃないってわかってるけど、差別的な言葉を使われてしんどかった"),
("たろう", "まじめにやりなよって言っただけでクラスのみんなに無視されるようになった。これってわたしが悪いのかな"),
("けん", "浪人２年目なんだけど、もうがんばるのムリだ。疲れた"),
("さくら", "仕事での勉強がキツイ。人間関係もゴタゴタしてるし、この業界向いてないや。"),
("はなこ", "信じてカミングアウトしたけど、やめとけばよかったな"),
("かなこ", "自分のセクシャリティ、考えれば考えるほどよくわかんなくなる"),
("たろう", "上司、時代遅れの価値観押し付けてくるのやめてくれ～"),
("けん", "独り身が最高だってやっと気付いた"),
("さくら", "おばあちゃんのこと大好きだったのに、介護してると嫌いになりそうになる。きついな"),
("はなこ", "父と兄が仲悪くて、ずっと喧嘩してる。家にいたくない…"),
("かなこ", "もうやだな、学校行きたくない"),
("たろう", "一回体調崩してから職場に行くのが体力的につらくて仕方ない。どうしたものかな。"),
("けん", "9時に出勤して23時に帰る生活やめてえ"),
("さくら", "もうほっといてほしい");
